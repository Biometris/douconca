...
expect_equal(mod_DivT_dccaA1$inertia, mod_DivT_dccaA11$inertia)
...
expect_warning(scores_SLA11 <- scores(mod_DivT_dccaSLA11, display = "reg_traits"),
               "Collinearity")
...
expect_stdout(mod_DivT_dcca_singular2 <- 
...
expect_stdout(mod_DivT_dcca_singular3 <- 
